...
<table class="shop_table cart" cellspacing="0">
	...
	<tbody>
			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
				...
				<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<td class="product-quantity">
						...
						?>
						<button type="submit" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" /></button>
						<?php
		...
		?>
		<tr class="cart_options">
			<td colspan="5" class="actions">
				<a href="<?php echo apply_filters( 'woocommerce_return_to_shop_redirect', get_permalink( wc_get_page_id( 'shop' ) ) ); ?>"><?php _e( 'Continue Shopping', 'woocommerce' ) ?></a>
				<a href="#" id="shipping-btn">Shipping Estimator</a>
